...
<head>
    ...
    $bigQuery = "SELECT p.Product_ID, p.Product_Name, p.Product_Picture, o.Order_ID, o.Order_Date, o.Order_TotalAmount, o.Order_Status, 
                 oi.OrderItem_Quantity, oi.OrderItem_UnitPrice, u.User_ID
                 FROM Orders o
                 INNER JOIN OrderItems oi ON o.Order_ID = oi.Order_ID
                 INNER JOIN Products p ON oi.Product_ID = p.Product_ID
                 INNER JOIN Users u ON o.User_ID = u.User_ID
                 WHERE o.User_ID = $Current_User ORDER BY Order_ID DESC";
    ...
    $To_Be_Deleted_Orders = "SELECT Order_ID , Order_Date FROM Orders WHERE User_ID = $Current_User 
                            AND Order_Status IN ('Cancelled By User', 'Cancelled by Management')";
    ...
    <div class="outer-container bg-gray-100 min-h-screen py-8">
        <div class="container mx-auto p-4 bg-white shadow-lg rounded-lg">
            <div class="content-wrapper pt-8">
                <h1 class="text-3xl font-bold mb-6 text-blue-800">Your Current Orders</h1>
                <?php if ($Orders) { ?>
                    <section>
