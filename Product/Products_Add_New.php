...
<head>
    ...
    if (!empty($_POST)) {
        ...
        if (!empty($_POST["Product_Name"])) {
            ...
            $lowercaseProductName = strtolower($Product_Name);
            ...
            if (!$existingProduct) {
                ...
                $queryManufacturer = "SELECT Manufacturer_ID FROM Manufacturers WHERE Manufacturer_Name = :Manufacturer_Name";
                $pdostmtManufacturer = $connexion->prepare($queryManufacturer);
                $pdostmtManufacturer->execute(['Manufacturer_Name' => $Manufacturer_Name]);
...
<body class="bg-gray-100">
    ...
    <div class="flex justify-center items-center bg-gray-100 min-h-screen py-8">
        <div class="container mx-auto bg-white shadow-lg rounded-lg p-8 w-full md:w-3/4 lg:w-1/2 form-wrapper">

            <div class="max-w-3xl mx-auto p-6 bg-white rounded shadow">
                <h1 class="text-3xl font-bold mb-6 text-blue-800 text-center">Add a New Product</h1>
                    ...
                    <div class="flex space-x-6">
                        ...
                        <div class="w-1/3">
                            ...
                            <div class="mb-4">
                                ...
                                <button type="button"
                                    class="mt-2 bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 rounded-md"
            ...
            <!-- JavaScript and any additional content -->
            <script>
                // JavaScript functions and adjustments
            </script>
        </div>
    </div>
