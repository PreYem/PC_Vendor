...
<head>
    ...
    <title>Add Category | PC Vendor</title>
    <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (!empty($_POST["Category_Name"])) {
            ...
            $Check_Unique_Category = "SELECT Category_ID FROM Categories
                           WHERE LOWER(Category_Name) = :Category_Name_Lower";
            $pdoCheck_Unique_Category = $connexion->prepare($Check_Unique_Category);
            $pdoCheck_Unique_Category->execute(["Category_Name_Lower" => $Category_Name_Lower]);

            $Unique_Category = $pdoCheck_Unique_Category->fetch(PDO::FETCH_ASSOC);

            if (!$Unique_Category) {
                $Insert_Category = "INSERT INTO Categories (Category_Name, Category_Desc) VALUES (:Category_Name, :Category_Desc)";
                $pdostmtUpdate = $connexion->prepare($Insert_Category);
                ...
                $_SESSION['Category_Add/Update'] = "Category Added Successfully";
